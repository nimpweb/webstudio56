    ...
    <Head>
      ...
      >
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis, dolorem odio deleniti explicabo nostrum repellat ipsum voluptatum tempore minima error assumenda doloremque consequuntur inventore cum maxime quaerat vitae. Dolor, aut.
          ...
          <ServiceContentItem>
            <div>
                <h3>Подключение личного кабинета сетевой компании под ключ</h3>
                <Price>от <span>10000</span> ₽/мес</Price>
                <List>
                  <li>Разработка уникального сайта</li>
                  <li>Заполненных страниц ~ 10-15</li>
                  <li>Раскрытие информации</li>
                  <li><sup><span style={{color: 'orangered'}}>*</span></sup>Подключение сервиса личного кабинета</li>
                  <li>Lorem ipsum dolor sit amet consectetur.</li>
                  <li>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque vel saepe tempore facilis ut quisquam.</li>
                </List>
                <div className="text-right w-100">
                  <Link href="/services/105">Подробнее...</Link>
                </div>
              </div>
              <Image 
                layout="fixed"
            ...
            <ServiceContentItem>
              ...
              <div>
                ...
                <Price>от <span>6000</span> ₽/мес</Price>
                <List>
